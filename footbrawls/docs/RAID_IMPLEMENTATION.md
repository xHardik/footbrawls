# Raid implementation bundle

**Status:** Ready to apply. In Cursor, switch to **Agent** mode and ask: `Apply all files from docs/RAID_IMPLEMENTATION.md`

---

## File: `src/lib/raidConstants.js`
...
export const R = { bg: '#060810', purple: '#A855F7', accent: '#F7C344', green: '#3DD68C', red: '#E84040', text: '#F2F2F4', muted: 'rgba(242,242,244,0.5)', border: 'rgba(255,255,255,0.07)', surface: 'rgba(255,255,255,0.04)' };
```

See plan file for remaining 8 files — **use Agent mode** for automatic creation.
